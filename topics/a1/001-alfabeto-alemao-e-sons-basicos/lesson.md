...
Em alemão, a pergunta mais comum para pedir soletração é: **Wie buchstabiert man das?** A resposta pode ser simples: **M-A-R-I-A**. Para dizer seu nome, use **Ich heiße...** e depois soletre se necessário.
...
| A-N-A | A-N-A | Soletração letra por letra. |
| Mein Name ist Bruno. | Meu nome é Bruno. | Outra forma de dizer o nome. |
| B-R-U-N-O | B-R-U-N-O | Soletração de nome. |
| Das ist ein W. | Isto é um W. | A letra W se chama "ve" em alemão. |
...
- Confundir **v** e **w** ao soletrar nomes, e-mails ou palavras.
